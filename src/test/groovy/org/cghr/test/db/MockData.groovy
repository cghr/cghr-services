...
class MockData {
    ...
    def structure = [
            ...
            inbox: [id: 'int', message: 'varchar(100)', sender: 'varchar(20)',dwnStatus:'varchar(20)', distList: 'varchar(20)']
    ]
    ...
    def sampleData = [
            ...
            userlog: [],
            inbox:[
                    [id:1,message:'file1.json',sender:'admin',distList: '1,2,3'],
                    [id:2,message:'file2.json',sender:'admin',distList: '4,5,6']
            ]
    ]
